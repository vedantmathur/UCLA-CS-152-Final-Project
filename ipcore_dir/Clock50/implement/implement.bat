...
xst -ifn xst.scr
move Clock50_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock50_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock50_exdes.ucf Clock50_exdes

echo 'Running map'
map -timing -pr b Clock50_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock50_exdes -w routed.ncd routed.v
cd ..
